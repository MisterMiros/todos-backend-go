...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/attributevalue v1.10.33 // indirect
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/expression v1.4.60 // indirect
